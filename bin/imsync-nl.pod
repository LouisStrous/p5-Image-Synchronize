...
padnaam of als een verzameling geografische coördinaten.  Als het een
gedeeltelijke padnaam is dan moet het bij precies één bestand horen en
dan wordt de geografische informatie uit dat bestand naar het
doelbestand gekopieerd.
...
Aanpassing is dan ook aangewezen als de GPS-locatie met tenminste 1
meter veranderd is, maar alleen als de originele GPS-locatie door
imsync was berekend (I<XMP:TimeSource> was gezet en ongelijk aan
C<GPS>).  We noemen zo'n GPS-positie I<flexibel>.  We willen niet te
gemakkelijk een GPS-positie verliezen die door de originele camera in
de metainformatie van het bestand werd geschreven.
